...
<h1> Selectati perioada raportului de vanzari: </h1> <br>
...
<table class="fl-table"  >
		<thead>
			<tr>
				...
				<th>Prenume agent</th>
                <th>Apartament</th>
                <th>Sumă fară TVA (EURO)</th>
                <th>Sumă cu TVA (EURO)</th>
                <th>Sumă fară TVA (RONI)</th>
                <th>Sumă cu TVA (RONI)</th>
			</tr>
		</thead>
...
//if (str == "") {
  ...
  xhttp.open("GET", "afiseaza_raport.php?ai=" + an_in + "&as=" + an_sf + "&li=" + luna_in + "&ls=" + luna_sf, true);
  xhttp.send();
